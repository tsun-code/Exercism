...
public class IsogramCheckerTest {
    ...
    @Test
    public void testIsogramWithSpecialCharacter() {
        IsogramChecker iso = new IsogramChecker();
        assertFalse(iso.isIsogram("thumbscrew&japingly"));
    }

    @Test
    public void testIsogramWithSpecialCharacters() {
        IsogramChecker iso = new IsogramChecker();
        assertFalse(iso.isIsogram("$thumbs^crew&japingly"));
    }

    @Test
    public void testNonIsogramWithSpecialCharacter() {
        IsogramChecker iso = new IsogramChecker();
        assertFalse(iso.isIsogram("thumbscrew*japinglty"));
    }
